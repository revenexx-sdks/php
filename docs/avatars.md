...
```http request
GET https://api.revenexx.com/v1/avatars/browsers/{code}
```
...
```http request
GET https://api.revenexx.com/v1/avatars/credit-cards/{code}
```
...
```http request
GET https://api.revenexx.com/v1/avatars/image
```
...
```http request
GET https://api.revenexx.com/v1/avatars/initials
```
...
```http request
GET https://api.revenexx.com/v1/avatars/qr
```
...
```http request
GET https://api.revenexx.com/v1/avatars/screenshots
```
...
| viewportWidth | integer | Browser viewport width. Pass an integer between 1 to 1920. Defaults to 1280. |  |
| viewportHeight | integer | Browser viewport height. Pass an integer between 1 to 1080. Defaults to 720. |  |
| scale | number | Browser scale factor. Pass a number between 0.1 to 3. Defaults to 1. |  |
| theme | string | Browser theme. Pass "light" or "dark". Defaults to "light". |  |
...
| sleep | integer | Wait time in seconds before taking the screenshot. Pass an integer between 0 to 10. Defaults to 0. |  |
| width | integer | Output image width. Pass 0 to use original width, or an integer between 1 to 2000. Defaults to 0 (original width). |  |
| height | integer | Output image height. Pass 0 to use original height, or an integer between 1 to 2000. Defaults to 0 (original height). |  |
| quality | integer | Screenshot quality. Pass an integer between 0 to 100. Defaults to keep existing image quality. |  |
