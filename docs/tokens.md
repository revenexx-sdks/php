...
```http request
GET https://api.revenexx.com/v1/tokens/buckets/{bucketId}/files/{fileId}
```
...
```http request
POST https://api.revenexx.com/v1/tokens/buckets/{bucketId}/files/{fileId}
```
...
```http request
DELETE https://api.revenexx.com/v1/tokens/{tokenId}
```
...
```http request
GET https://api.revenexx.com/v1/tokens/{tokenId}
```
...
```http request
PATCH https://api.revenexx.com/v1/tokens/{tokenId}
```
