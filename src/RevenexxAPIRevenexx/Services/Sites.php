...
class Sites extends Service
{
     ...
     * @return string
     */
    public function sitesDelete(string $siteId): string
    {
        $apiPath = str_replace(
            ['{siteId}'],
            [$siteId],
     ...
     * @return array
     */
    public function sitesCreateDeployment(string $siteId, bool $activate, string $code, ?string $buildCommand = null, ?string $installCommand = null, ?string $outputDirectory = null, ?callable $onProgress = null): array
    {
        $apiPath = str_replace(
            ['{siteId}'],
            [$siteId],
     ...
     * @return array
     */
    public function sitesCreateTemplateDeployment(string $siteId, string $owner, string $reference, string $repository, string $rootDirectory, Type $type, ?bool $activate = null): array
    {
        $apiPath = str_replace(
            ['{siteId}'],
            [$siteId],
     ...
     * @return array
     */
    public function sitesCreateVcsDeployment(string $siteId, string $reference, Type $type, ?bool $activate = null): array
    {
        $apiPath = str_replace(
            ['{siteId}'],
            [$siteId],
     ...
     * @return string
     */
    public function sitesDeleteDeployment(string $siteId, string $deploymentId): string
    {
        $apiPath = str_replace(
            ['{siteId}', '{deploymentId}'],
            [$siteId, $deploymentId],
     ...
     * @return array
     */
    public function sitesGetDeploymentDownload(string $siteId, string $deploymentId, ?Type $type = null): array
    {
        $apiPath = str_replace(
            ['{siteId}', '{deploymentId}'],
            [$siteId, $deploymentId],
     ...
     * @return string
     */
    public function sitesDeleteLog(string $siteId, string $logId): string
    {
        $apiPath = str_replace(
            ['{siteId}', '{logId}'],
            [$siteId, $logId],
     ...
     * @return string
     */
    public function sitesDeleteVariable(string $siteId, string $variableId): string
    {
        $apiPath = str_replace(
            ['{siteId}', '{variableId}'],
            [$siteId, $variableId],
