...
class Avatars extends Service
{
     ...
     * @return array
     */
    public function avatarsGetCreditCard(Code $code, ?int $width = null, ?int $height = null, ?int $quality = null): array
    {
        $apiPath = str_replace(
            ['{code}'],
            [$code],
     ...
     * @return array
     */
    public function avatarsGetFavicon(string $url): array
    {
        $apiPath = str_replace(
            [],
            [],
     ...
     * @return array
     */
    public function avatarsGetFlag(Code $code, ?int $width = null, ?int $height = null, ?int $quality = null): array
    {
        $apiPath = str_replace(
            ['{code}'],
            [$code],
