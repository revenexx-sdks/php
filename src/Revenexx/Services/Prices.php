...
class Prices extends Service
{
     ...
     * @param ?bool $dryRun
     * @param ?float $percent
     * @param ?PriceEndingRule $rounding
     * @param ?string $skuPrefix
     * @throws RevenexxException
     * @return array
     */
    public function pricesEntriesAdjust(string $listId, ?float $amount = null, ?bool $dryRun = null, ?float $percent = null, ?PriceEndingRule $rounding = null, ?string $skuPrefix = null): array
    {
        $apiPath = str_replace(
            ['{list_id}'],
            [$listId],
            '/v1/prices/lists/{list_id}/entries/adjust'
        );
        ...
        $apiParams['percent'] = $percent;
        $apiParams['rounding'] = $rounding;
        $apiParams['sku_prefix'] = $skuPrefix;
     ...
     * @param string $listId
     * @param array $entries
     * @param ?PriceEntriesBulkMode $mode
     * @throws RevenexxException
     * @return array
     */
    public function pricesEntriesBulk(string $listId, array $entries, ?PriceEntriesBulkMode $mode = null): array
    {
        $apiPath = str_replace(
            ['{list_id}'],
            [$listId],
     ...
     * @return array
     */
    public function pricesEntriesLadder(string $listId, float $basePrice, ?float $discountPercent = null, ?string $productId = null, ?array $quantities = null, ?bool $replace = null, ?PriceEndingRule $rounding = null, ?string $sku = null, ?string $unit = null): array
    {
        $apiPath = str_replace(
            ['{list_id}'],
            [$listId],
            '/v1/prices/lists/{list_id}/entries/ladder'
        );
        ...
        $apiParams['product_id'] = $productId;
        $apiParams['quantities'] = $quantities;
     ...
     * @return array
     */
    public function pricesListsMakeDefault(string $listId, array $data): array
    {
        $apiPath = str_replace(
            ['{list_id}'],
            [$listId],
            '/v1/prices/lists/{list_id}/make-default'
        );
     ...
     * @return array
     */
    public function pricesVocabulariesList(): array
    {
        $apiPath = str_replace(
            [],
            [],
            '/v1/prices/vocabularies'
        );
     ...
     * tax-bases.
     *
     * @param PricesVocabulariesGetName $name
     * @throws RevenexxException
     * @return array
     */
    public function pricesVocabulariesGet(PricesVocabulariesGetName $name): array
    {
        $apiPath = str_replace(
            ['{name}'],
            [$name],
            '/v1/prices/vocabularies/{name}'
        );
