...
class Apps extends Service
{
     ...
     * @return array
     */
    public function appsDelete(string $functionId): array
    {
        $apiPath = str_replace(
            ['{functionId}'],
            [$functionId],
     ...
     * @return array
     */
    public function appsCreateDeployment(string $functionId, bool $activate, InputFile $code, ?string $commands = null, ?string $entrypoint = null, ?callable $onProgress = null): array
    {
        $apiPath = str_replace(
            ['{functionId}'],
            [$functionId],
     ...
     * @param string $functionId
     * @param string $reference
     * @param AppsCreateVcsDeploymentType $type
     * @param ?bool $activate
     * @throws RevenexxException
     * @return array
     */
    public function appsCreateVcsDeployment(string $functionId, string $reference, AppsCreateVcsDeploymentType $type, ?bool $activate = null): array
    {
        $apiPath = str_replace(
            ['{functionId}'],
            [$functionId],
     ...
     * @return array
     */
    public function appsDeleteDeployment(string $functionId, string $deploymentId): array
    {
        $apiPath = str_replace(
     ...
     * @return array
     */
    public function appsGetDeploymentDownload(string $functionId, string $deploymentId, ?AppsGetDeploymentDownloadType $type = null): array
    {
        $apiPath = str_replace(
            ['{functionId}', '{deploymentId}'],
            [$functionId, $deploymentId],
     ...
     * @return array
     */
    public function appsDeleteExecution(string $functionId, string $executionId): array
    {
        $apiPath = str_replace(
     ...
     * @return array
     */
    public function appsDeleteVariable(string $functionId, string $variableId): array
    {
        $apiPath = str_replace(
